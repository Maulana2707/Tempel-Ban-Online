      ...
      <div class="container">
    	...
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate" >
            <h2 class="mb-4">Tempel Ban terdekat</h2>
          </div>
        ...
        <div class="row about-extra justify-content-center">
          <div class="col-lg-4">
            <img src="images/3.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6  pt-5 ">
            <h4>Pendaftaran Lokasi Tempel Ban </h4>
            <p>
              Yuk silahkan daftar Lokasi Tempel Ban terbaru anda di On-Tem. Informasi yang diberikan dapat mempermudah Pengendara.
            </p>
        ...
        <div class="row about-extra justify-content-center">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h4>Pemetaan Lokasi Tempel Ban Online</h4>
            <p>
             Lihat di peta untuk Lokasi Tempel Ban yang sudah terdaftar di Aplikasi On-Tem. Temukan lokasi Tempel Ban sekitar agar mempermudah perjalanan anda.
            </p>
            <a href="map.php">
              <button type="button" class="btn btn-secondary">Selengkapnya</button>
            </a>
