      ...
      <div class="container">
        ...
        <form role="form" action="edit-aksi.php" method="post" enctype="multipart/form-data">
                  <div class="form-inline">
                    ...
                    <input type="text" name="nama" value="<?php echo $data['nama'] ?>" class="form-control" id="exampleInputEmail2" placeholder="Nama Tempel Ban">
                  </div>
                  </div><br>
                  <div class="form-inline">
                    <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $data['alamat'] ?>" name="alamat" id="exampleInputEmail1" placeholder="Alamat Tempel Ban">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $data['deskripsi'] ?>" name="desc" id="exampleInputEmail1" placeholder="Deskripsi Tempel Ban">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $data['hp'] ?>" name="hp" id="exampleInputEmail1" placeholder="Nomor Hp">
                  </div> <div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $data['google'] ?>" name="google" id="exampleInputEmail1" placeholder="Google Maps">
                  </div>
                  <div class="form-group">
